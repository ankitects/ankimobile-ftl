about-anki-written-by = AnkiMobile, Damien Elmes ve Richard Smith tarafından yazıldı, ve Damien'in Anki'nin bilgisayar versiyonu çalışmasına dayandı.
about-license-text = AnkiMobile, yazılım geliştirici topluluğu tarafından cömertçe paylaşılan { $link } ile kuruldu.
