...
preferences-autoplay-in-silent-mode = Tự động bật với Chế độ Im lặng
preferences-always-duck = Luôn luôn Ẩn Hình nền
...
preferences-auto-advance-auto-advance-to-start = Để bắt đầu tự động nâng cao cấp độ, hãy sử dụng tác vụ 'Tự động Đi tiếp'.
...
preferences-gamepad-thumbpad-deadzone = % Khu vực chết Bàn phím cảm ứng
...
preferences-never-show-scratchpad = Không bao giờ hiện Vùng tạm
preferences-never-show-scratchpad-enabled = Không bao giờ hiển thị Vùng tạm được bật trong màn hình Tùy chọn.
...
preferences-loop-video = Lặp lại video
preferences-show-video-controls = Hiển thị Điều khiển Cideo
preferences-high-quality-video = Video Chất lượng Cao
preferences-auto-capitalize = Tự động Viết Hoa
preferences-auto-correct = Tự động Sửa
preferences-strip-hebrew-vowels = Loại bỏ Nguyên âm Tiếng Do Thái
