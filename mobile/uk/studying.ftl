studying-auto-advance-starting = Автоматичний запуск прогресу
studying-auto-advance-stopped = Автоматична зупинка просування
# ...have (5 cards) ready...
studying-have-ready-to-study = У вас є { $numCards } готових для вивчення.
