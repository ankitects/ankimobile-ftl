...
deck-options-delete-options-full-sync = Si elimines aquest grup d’opcions, els canvis recents fets en altres dispositius no es fusionaran durant la pròxima sincronització. Vols continuar?
...
deck-options-reset-all-settings-to-defaults = Vols reestablir la configuració per defecte?
