...
editing-cant-edit-original-image-data = 無法編輯 - 找不到原始影像資料。
...
editing-unable-to-obtain-image = 無法取得影像
editing-unable-to-read-file = 無法讀取檔案
editing-underline = 底線
editing-unexpected-file-extension = 非預期的副檔名：
editing-unexpected-rich-text-format-please = 非預期的 RTF 格式 - 請嘗試複製貼上。
editing-unexpected-status-code = 非預期的狀態代碼：
