...
preferences-scratchpad-transparency-medium = 中等透明
preferences-scratchpad-transparency-none = 不透明
preferences-scratchpad-transparency-slight = 略微透明
preferences-shake-action = 搖動手機動作
preferences-short = 短
preferences-show-bottom-bar = 顯示底部列
preferences-show-grid = 顯示格線
preferences-show-top-bar = 顯示頂部列
preferences-small = 小
preferences-swipe-down = 向下滑動
preferences-swipe-left = 向左滑動
preferences-swipe-right = 向右滑動
preferences-swipe-up = 向上滑動
...
preferences-undo-clears-all = 復原按鈕清除所有筆跡
