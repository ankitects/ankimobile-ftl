...
deck-options-bury-related-reviews = 暫停關聯的待複習卡片
deck-options-defaults = 預設
deck-options-delete-options-full-sync = 刪除這個選項群組將會在下一次同步時阻止合併來自其他裝置的任何變更。是否繼續？
...
deck-options-max-reviews-per-day = 每天待複習卡片上限
