...
info-plist-add-cards = Карта Қосу
info-plist-search = Іздеу

## File imports

info-plist-packaged-collection = Қапталған Anki Жинағы
info-plist-packaged-anki-deck = Қапталған Anki Колодасы
