...
preferences-open-links-externally = Адкрываць спасылкі ў браўзэры
preferences-drawing-screen-ignores-fingers = Ігнараваць пальцы на экране малявання
preferences-feedback-ticks = Дубляваць абраную ацэнку
preferences-spread-ticks = Дубляваць абраную ацэнку над адпаведнай кнопкай
...
preferences-gamepad-thumbpad-deadzone = Мёртвая зона для вялікага пальца %
...
preferences-notifications-settings-app-enable-notifications = Калі ласка, адкройце сістэмныя налады, абярыце Anki і дазвольце апавяшчэнні, значкі і папярэджванні
...
preferences-swipes-must-begin-from-the-far = Гартанне павінна ісці з левага альбо правага краю экрана
...
preferences-editing-resize-on-paste = Змяняць памер падчас устаўлення
# convert smart quotes and smart dashes to ASCII style
preferences-editing-convert-smart-quotes = Канвертаваць разумныя двукоссі і злучкі
...
preferences-high-quality-video = Відэа высокай якасці
preferences-auto-capitalize = Аўтаматычна выкарыстоўваць вялікія літары
