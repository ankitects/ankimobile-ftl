...
actions-current-audio-minus-5s = ଚଳିତ ଅଡ଼ିଓ -୫ସେ
actions-current-audio-plus-5s = ଚଳିତ ଅଡ଼ିଓ +୫ସେ
actions-deck-statistics = ତାସଖଣ୍ଡର ପରିସଂଖ୍ୟାନ
actions-delete-note-and-its-cards = ନୋଟ୍ ଏବଂ ଏହାର ସମସ୍ତ ପତ୍ର ବିଲୋପ କରିବାକୁ ଚାହୁଁଛନ୍ତି କି?
actions-discard-changes = ପରିବର୍ତ୍ତନଗୁଡ଼ିକୁ ପରିତ୍ୟାଗ କରନ୍ତୁ
actions-done = ହୋଇଗଲା
...
actions-off = ବନ୍ଦ
actions-processing = ପ୍ରକ୍ରିୟାକରତ...
...
actions-current-audio-minus-5s-short = -୫ସେ
actions-current-audio-plus-5s-short = +୫ସେ
