...
actions-an-error-occurred = Ein Feh­ler ist auf­ge­tre­ten: %@
...
actions-current-audio-minus-5s = Audiowiedergabe zurückspulen -5%
...
actions-filtered-deck = Auswahlstapel %i
actions-flag-1 = Markierung 1
actions-flag-1-red = Markierung 1 (Rot)
actions-flag-2 = Markierung 2
actions-flag-2-orange = Markierung 2 (Orange)
actions-flag-3 = Markierung 3
actions-flag-3-green = Markierung 3 (Grün)
actions-flag-4 = Markierung 4
actions-flag-4-blue = Markierung 4 (Blau)
actions-forgot-card = Vergessene Karte
actions-frequent-actions = Häufige Aktionen
actions-how-many-days-in-the-future = Wie viele Tage in der Zukunft?
actions-invalid-number-of-days = Ungültige Anzahl an Tagen.
...
actions-note-and-its-cards-deleted = Notiz und ihre %i Karten gelöscht
actions-note-and-its-cards-suspended = Notiz und ihre %i Karte(n) ausgesetzt
...
actions-off = Aus
actions-pause-audio-short = Pausieren
