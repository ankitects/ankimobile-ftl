...
info-plist-add-cards = Kar­ten hin­zu­fü­gen
info-plist-search = Suche

## File imports

info-plist-packaged-collection = Komprimierte Anki-Sammlung
info-plist-packaged-anki-deck = Kom­pri­mier­ter Anki-Stapel
