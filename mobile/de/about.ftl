...
about-license-text = AnkiMobile ist mit %@ erstellt worden, großzügig geteilt von der Entwicklergemeinschaft.
about-please-see = Bitte konsultieren Sie %@ für weitere Informationen.
about-some-thirdparty-libraries = einige Bibliotheken von Drittanbietern
about-thanks-contributors = Ein großes Dankeschön an alle Personen, die mit Vorschlägen, Fehlerberichten und Spenden zur Weiterentwicklung von Anki beigetragen haben.
