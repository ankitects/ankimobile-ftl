...
preferences-autoplay-in-silent-mode = 무음 모드에서 자동 재생
preferences-always-duck = 항상 배경 소리 줄이기
...
preferences-open-links-externally = 외부 링크 열기
...
preferences-gamepad-thumbpad-deadzone = 조이스틱 입력 방지 %
...
preferences-notifications-app-icon-shows-due-count = 앱 아이콘에서 마감 개수 표시하기
...
preferences-remaining-count = 남은 개수
