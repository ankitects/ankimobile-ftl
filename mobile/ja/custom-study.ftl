...
custom-study-days-to-look-ahead = 先取りする範囲
custom-study-days-to-look-back = 遡る日数
custom-study-exclude-cards-with-tag = タグ付カードを除外
custom-study-extra-new-cards = 新規カード増量
custom-study-extra-review-cards = 復習カード増量
custom-study-include-cards-with-tag = タグ付カードを含める
custom-study-learn-new-cards-with-certain-tags = タグ付新規カードを学習
custom-study-loading = 読み込み中...
custom-study-max-cards-to-gather = カード枚数の上限
# no tags selected
custom-study-no-tags = なし
