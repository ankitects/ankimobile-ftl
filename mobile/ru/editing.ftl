editing-bold = Полужирный
editing-cancel-and-lose-any-unsaved-changes = Отменить без сохранения изменений?
editing-cant-edit-original-image-data = Редактирование невозможно - источник изображения не найден.
editing-card-returned-to-new-card-queue = Карточка возвращена в очередь новых карточек.
editing-card-unsuspended = Карточка включена
editing-from-camera = Из камеры
...
editing-unable-to-read-file = Не удалось прочитать файл
editing-underline = Подчеркивание
editing-unexpected-file-extension = Неожиданное разрешение файла:
editing-unexpected-rich-text-format-please = Неожиданный RTF - попробуйте скопировать и вставить.
