...
custom-study-days-to-look-back = Дней до повторения
custom-study-exclude-cards-with-tag = Исключить карточки с пометкой
custom-study-extra-new-cards = Дополнительные новые карточки
custom-study-extra-review-cards = Дополнительные карточки для повтора
custom-study-include-cards-with-tag = Включить карточки с пометкой
custom-study-learn-new-cards-with-certain-tags = Учить новые карточки с опред. пометками
custom-study-loading = Грузится...
custom-study-max-cards-to-gather = Макс. карточек для сбора
custom-study-no-tags = нет
