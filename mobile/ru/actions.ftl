...
actions-custom-study-cant-be-used-on = Допзанятие не может быть на фильтрованной колоде.
...
actions-you-can-only-empty-a-filtered = Можно очищать только фильтрованную колоду.
