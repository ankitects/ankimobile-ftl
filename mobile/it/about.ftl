about-anki-written-by = AnkiMobile è stato sviluppato da Damien Elmes e Richard Smith e si basa sul lavoro di Damien per la versione desktop di Anki.
about-license-text = AnkiMobile è basato su { $link }, generosamente condiviso dalla comunità degli sviluppatori.
about-please-see = Visitare { $link } per ulteriori informazioni.
