...
deck-options-display-in-order-added = Visualizza in ordine di aggiunta
deck-options-display-in-random-order = Visualizza in ordine casuale
deck-options-full-sync-required = Sincronizzazione Completa Richiesta
deck-options-group-name = Nome del gruppo
deck-options-max-new-per-day = Numero massimo di carte giornaliere
