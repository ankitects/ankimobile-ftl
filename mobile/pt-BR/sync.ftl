...
sync-password = Senha
sync-please-enter-your-ankiweb-details = Por favor, insira seus detalhes do 'AnkiWeb'.
...
sync-media-missing-file = Esquecendo arquivo: { $filename }. Certifique-se de que a sincronização de mídia esteja completa.
