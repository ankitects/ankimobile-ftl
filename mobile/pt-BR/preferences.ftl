...
preferences-backup-revert-to-backup = &Reverter para Backup
...
preferences-backup-reverted-to-backup = &Reverter para Backup
...
preferences-open-links-externally = Abrir Links Externamente
...
preferences-notifications-app-icon-shows-due-count = O ícone do aplicativo mostra a contagem pendentes
