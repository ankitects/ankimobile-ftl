...
browsing-due-reviews = Avaliações devidas
browsing-learning-cards = Cartões de Aprendizagem
browsing-no-cards-are-selected = Nenhum cartão selecionado.
browsing-note-created = Nota Criada
browsing-note-updated = Nota Atualizada
browsing-note2 = Nota:
browsing-questionandanswer = Pergunta+Resposta
...
browsing-larger-font = Fonte Maior
