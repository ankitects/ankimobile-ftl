editing-bold = غامق
editing-cancel-and-lose-any-unsaved-changes = هل تريد الإلغاء وخسران أي تغييرات غير محفوظة؟
editing-cant-edit-original-image-data = تعذر التعديل - بيانات الصورة الأصلية غير موجودة.
editing-card-returned-to-new-card-queue = عادت البطاقة إلى صف البطاقات الجديدة.
editing-card-unsuspended = فُعِّلت البطاقة
editing-from-camera = من الكاميرا
...
editing-unable-to-read-file = تعذرت قراءة الملف
editing-underline = وضع خط تحت النص
editing-unexpected-file-extension = لاحقة ملف غير متوقعة:
editing-unexpected-rich-text-format-please = صيغة نص منسق غير متوقعة - الرجاء محاولة النسخ واللصق.
