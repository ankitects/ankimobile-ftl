...
custom-study-days-to-look-back = Breathnaigh siar an oiread seo laethanta
custom-study-exclude-cards-with-tag = Ná bíodh cárta leis an gclib seo san áireamh:
custom-study-extra-new-cards = Cártaí nua sa bhreis
custom-study-extra-review-cards = Cártaí athbhreithnithe sa bhreis
custom-study-include-cards-with-tag = Bíodh cárta leis an gclib seo san áireamh:
custom-study-learn-new-cards-with-certain-tags = Foghlaim cártaí nua a bhfuil na clibeanna seo ag gabháil leo
custom-study-loading = Ag lódáil...
custom-study-max-cards-to-gather = Uasmhéid cártaí le tiomsú
# no tags selected
custom-study-no-tags = ceann ar bith
